...
import { shopHeaderCreateItems } from './sidebar/sidebar-navigation/navigation-items'
    ...
    <div class="mx-auto flex max-w-shop-layout">
      ...
      <div class="min-w-0 grow">
        <div class="shop-layout-content-inner flex items-center justify-between">
          <div class="h-fit rounded-lg bg-surface-muted transition-colors hover:bg-surface-control">
            <!-- <UInput
              icon="search"
              placeholder="Search"
              variant="none"
