...
import { useGetBestSellerProducts } from '~/domains/product/queries/products.query'
import type { GetProductRecommendationsResponse } from '~/domains/product/api/contracts/product.contract'
